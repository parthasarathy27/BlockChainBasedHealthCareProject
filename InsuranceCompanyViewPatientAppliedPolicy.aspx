<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InsuranceCompanyViewPatientAppliedPolicy.aspx.cs" Inherits="InsuranceCompanyViewPatientAppliedPolicy" %>
     ...
     <table align="center" border="0" width="70%"  cellpadding ="10px">
        ...
        <tr>
            ...
            <center>
                ...
                <asp:BoundField DataField ="padate" HeaderText ="Date" HtmlEncode ="false" DataFormatString ="{0:dd-MMM-yyyy}" />
                ...
                <asp:BoundField DataField ="vperiod" HeaderText ="Validity Period" />
