<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewPatientHealthReport.aspx.cs" Inherits="ViewPatientHealthReport" %>
...
<ControlStyle Height="100px" Width="100px"></ControlStyle>
                ...
                <asp:BoundField DataField ="tdate" HeaderText ="Treatment Date" />
        ...
        <tr>
            <td style ="text-align :center ;" colspan="2">
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click" 
                    Font-Bold="True">Add New Health Report</asp:LinkButton>
            </td>
        </tr>
